...
void getToFrom(char* dst, char* from, char* to, int* day, int* timeStamp, bool correctTimeZone)
{
    ...
    // In alcuni casi viene passato l'orario gi� corretto del TimeZone, quindi non devo modificarlo.
    if (correctTimeZone)
    {
...
void drawData()
{
    ...
    while (entriesNum < MAX_CALENDAR_EVENTS && i < n && strstr(data + i, "BEGIN:VEVENT"))
    {
        ...
        // Il parametro ;VALUE=DATE indica che non � presente l'orario perch� l'evento occupa tutto il giorno.
