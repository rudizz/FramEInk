...
bool drawEvent(entry* event, int day, int beginY, int maxHeigth, int* heigthNeeded)
{
    ...
    int lastSpace = -100;
    display.setCursor(x1 + 5, beginY + 36); // offset tra la linea alta della griglia e l'inizio del testo
...
void drawWeatherTemp(int x, int y, int day)
{
    ...
    display.drawBitmap3Bit(x + 43, y - 28, termometro, termometro_w, termometro_h);
}
// PREDICTABILITY
